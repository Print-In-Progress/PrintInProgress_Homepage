...
const Footer = () => {
  ...
  return (
    <footer className="border-t border-gray-300 border-opacity-10 bg-navbar-bg bg-opacity-20 px-4 py-6 backdrop-blur-button">
      <div className="mx-auto mt-auto flex w-full max-w-7xl flex-col gap-5">
        {/* Legal Links */}
