...
export const moduleCategories = {
  "Core Platform": {
    title: "Core Platform",
    description: "Essential features that power the entire platform",
    modules: [
      {
        id: "user-management",
  ...
  "Communication & Collaboration": {
    ...
    description: "Tools for interaction and information sharing",
    modules: [
      {
        id: "newspaper",
        title: "Newspaper",
  ...
  "Learning & Education": {
    ...
    description:
      "Features focused on educational content and learning management",
    modules: [
      {
        id: "digital-library",
  ...
  "Event & Activity Management": {
    ...
    description: "Tools for organizing and managing school activities",
    modules: [
      {
        id: "events",
        title: "Events",
  ...
  "Assessment & Tracking": {
    ...
    description: "Tools for monitoring and evaluating student progress",
    modules: [
      {
        id: "surveys",
        title: "Surveys",
