export const useTermsConfig = () => {
  return {
    lastUpdated: "December 27, 2023",
    introduction: {
      title: "Agreement to our Legal Terms",
      content: [
        'We are Print In Progress LLC, doing business as Print In Progress and PIP ("Company," "we," "us," "our"). Our VAT number is 92-4028846.',
        'We operate the mobile application NewsApp (the "App"), as well as any other related products and services that refer or link to these legal terms (the "Legal Terms") (collectively, the "Services").',
        "The NewsApp is a custom made communications, data sharing and publication platform for all kinds of organizations. Organizations can add modules to the platform to make it fit their unique needs. We offer a variety of modules such as an Educational AI, Surveys, Chats or Digital Library Module.",
        "You can contact us by phone at +1 (415) 254-4147, email at support@printinprogress.net, or by mail to 916 Rockdale Drive, San Francisco, CA 94127, United States.",
        'These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of an entity ("you"), and Print In Progress LLC, concerning your access to and use of the Services. You agree that by accessing the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. IF YOU DO NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU MUST DISCONTINUE USE IMMEDIATELY.',
    ...
    mainPart: [
        ...
        sections: [
          {
            ...
            content: [
              ...
              {
                type: "normal",
                text: 'The Content and Marks are provided in or through the Services "AS IS" for the intended purpose only.',
              },
            ],
          },
          {
            id: "your_use_of_our_services",
            heading: "Your use of our Services",
            content: [
              {
                type: "normal",
              ...
              {
                type: "normal",
                text: "solely for the intended purpose.",
              },
              {
                type: "normal",
              ...
              {
                type: "normal",
                text: "If you wish to make any use of the Services, Content, or Marks other than as set out in this section or elsewhere in our Legal Terms, please address your request to: support@printinprogress.net. If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you must identify us as the owners or licensors of the Services, Content, or Marks and ensure that any copyright or proprietary notice appears or is visible on posting, reproducing, or displaying our Content.",
              },
              {
                type: "normal",
          ...
          {
            id: "your_submissions_and_contributions",
      ...
      },
      {
        ...
        sections: [
          {
            id: "user_representations_section",
            content: [
              {
                type: "normal",
      ...
      {
        id: "purchase_and_payment",
        title: "PURCHASE AND PAYMENT",
        sections: [
          {
            id: "purchase_and_section",
            content: [
              {
                type: "normal",
              ...
              },
              {
                ...
                points: [
                  ...
                  "PayPal",
                  "American Express",
                  "USD, EUR and GBP bank transfers",
                  "SEPA Direct Debit",
              ...
              {
                type: "normal",
                text: "You agree to provide current, complete, and accurate purchase and account information for all purchases made via the Services. You further agree to promptly update account and payment information, including email address, payment method, and payment card expiration date, so that we can complete your transactions and contact you as needed. Sales tax will be added to the price of purchases as deemed required by us. We may change prices at any time. All payments shall be in US dollars, Euros or GBP.",
              },
              {
                type: "normal",
        ...
        sections: [
          {
            ...
            content: [
              {
                type: "normal",
                text: "All purchases are non-refundable. You can cancel your subscription at any time by contacting us using the contact information provided below. Your cancellation will take effect at the end of the current paid term.",
              },
              {
                type: "normal",
                text: "If you are unsatisfied with our Services, please email us at support@printinprogress.net or call us at +1 (415) 254-4147.",
              },
            ],
          },
        ],
      ...
      },
      {
        ...
        sections: [
          {
            id: "prohibited_activities_section",
            content: [
              {
                type: "normal",
              ...
              },
              {
                ...
                points: [
                  ...
                  "Use the Services to advertise or offer to sell goods and services unless you have permission to do so.",
      ...
      },
      {
        ...
        sections: [
          {
            id: "user_generated_contributions_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "contribution_license_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          ...
          {
            id: "apple_and_android_devices",
            heading: "Apple and Android Devices",
            content: [
              {
                type: "normal",
      ...
      {
        id: "third_party_websites_and_consent",
        title: "THIRD-PARTY WEBSITES AND CONSENT",
        sections: [
          {
            id: "third_party_websites_and_consent_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "services_management_section",
            content: [
              {
                type: "normal",
        ...
        sections: [
          {
            ...
            content: [
              {
                type: "normal",
                text: "We care about data privacy and security. Please review our Privacy Policy: http://www.printinprogress.net/privacy. By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. Please be advised the Services are hosted in the United States and Germany. If you access the Services from any other region of the world with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws in the United States and Germany, then through your continued use of the Services, you are transferring your data to the United States and Germany, and you expressly consent to have your data transferred to and processed in the United States and Germany. Further, we do not knowingly accept, request, or solicit information from children or knowingly market to children. Therefore, in accordance with the U.S. Children's Online Privacy Protection Act, if we receive actual knowledge that anyone under the age of 13 has provided personal information to us without the requisite and verifiable parental consent, we will delete that information from the Services as quickly as is reasonably practical.",
              },
            ],
          },
        ],
      },
      {
        ...
        sections: [
          {
            id: "copyright_infringements_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "term_and_termination_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "modifications_and_interruptions_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "governing_law_section",
            content: [
              {
                type: "normal",
                text: "These Legal Terms and your use of the Services are governed by and construed in accordance with the laws of the State of California applicable to agreements made and to be entirely performed within the State of California, without regard to its conflict of law principles.",
              },
            ],
          },
        ],
      ...
      {
        id: "duspute_resolution",
        title: "DISPUTE RESOLUTION",
        sections: [
          {
            id: "informal_negotiations",
            heading: "Informal Negotiations",
            content: [
              {
                type: "normal",
              ...
              {
                type: "normal",
                text: `If the Parties are unable to resolve a Dispute through informal negotiations, the Dispute (except those Disputes expressly excluded below) will be finally and exclusively resolved by binding arbitration. YOU UNDERSTAND THAT WITHOUT THIS PROVISION, YOU WOULD HAVE THE RIGHT TO SUE IN COURT AND HAVE A JURY TRIAL. The arbitration shall be commenced and conducted under the Commercial Arbitration Rules of the American Arbitration Association ("AAA") and, where appropriate, the AAA's Supplementary Procedures for Consumer Related Disputes("AAA Consumer Rules"), both of which are available at the American Arbitration Association(AAA) website s and, where appropriate, limited by the AAA Consumer Rules.The arbitration may be conducted in person, through the submission of documents, by phone, or online.The arbitrator will make a decision in writing, but need not provide a statement of reasons unless requested by either Party.The arbitrator must follow applicable law, and any award may be challenged if the arbitrator fails to do so.Except where otherwise required by the applicable AAA rules or applicable law, the arbitration will take place in San Francisco, California.Except as otherwise provided herein, the Parties may litigate in court to compel arbitration, stay proceedings pending arbitration, or to confirm, modify, vacate, or enter judgment on the award entered by the arbitrator.`,
              },
              {
                type: "normal",
                text: "If for any reason, a Dispute proceeds in court rather than arbitration, the Dispute shall be commenced or prosecuted in the state and federal courts located in United States of America , California, and the Parties hereby consent to, and waive all defenses of lack of personal jurisdiction, and forum non conveniens with respect to venue and jurisdiction in such state and federal courts. Application of the United Nations Convention on Contracts for the International Sale of Goods and the Uniform Computer Information Transaction Act (UCITA) are excluded from these Legal Terms.",
              },
              {
                type: "normal",
          ...
          {
            id: "exceptions_to_informal_negotiations_and_arbitration",
            heading: "Exceptions to Informal Negotiations and Arbitration",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "electronic_communications_transactions_and_signatures_section",
            content: [
              {
                type: "normal",
      ...
      },
      {
        ...
        sections: [
          {
            id: "california_users_and_residents_section",
            content: [
              {
                type: "normal",
        ...
        sections: [
          {
            ...
            content: [
              ...
              },
              {
                type: "contact",
                info: [
                  "Print In Progress LLC",
                  "916 Rockdale Drive",
                  "San Francisco, CA 94127",
                  "United States",
                  "Phone: +1 (415) 254-4147",
                  "support@printinprogress.net",
                ],
              },
            ],
          },
